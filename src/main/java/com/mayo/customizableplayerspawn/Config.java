...
public final class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> SELECTED_PROFILE = BUILDER
            .comment(
    ...
    public static final ForgeConfigSpec.ConfigValue<String> TERRAIN_PREPARATION_MODE = BUILDER
            .comment(
    ...
    public static final ForgeConfigSpec.IntValue TERRAIN_PADDING = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> TERRAIN_TOP_BLOCK = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> TERRAIN_FILL_BLOCK = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> TERRAIN_CORE_BLOCK = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue TERRAIN_EDGE_NOISE = BUILDER
            .comment("Use deterministic noise to break up ISLAND terrain edges.")
            .define("terrainEdgeNoise", true);

    public static final ForgeConfigSpec.BooleanValue CLEAR_STRUCTURE_VOLUME = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue CLEAR_VOLUME_PADDING = BUILDER
            .comment("Extra horizontal and vertical air clearance around the structure volume.")
            .defineInRange("clearVolumePadding", 2, 0, 32);

    public static final ForgeConfigSpec.BooleanValue FILL_SUPPORT_VOIDS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue SUPPORT_VOID_MAX_FILL_DEPTH = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue ISLAND_MAX_DROP = BUILDER
            .comment("Maximum Y drop from the structure floor to the outer ISLAND edge.")
            .defineInRange("islandMaxDrop", 8, 0, 64);

    public static final ForgeConfigSpec.IntValue ISLAND_EDGE_FALLOFF = BUILDER
